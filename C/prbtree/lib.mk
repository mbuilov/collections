...
$(call MAKE_CONTINUE,SRC INCLUDE USE)
...
LIBRARY_HDIR :=
LIBRARY_HEADERS := btree.h prbtree.h
...
# $2 - library variant
PRBTREE_PC_GENERATOR = $(call PKGCONF_DEF_TEMPLATE,$1,$(MODVER),$(PRODUCT_NAME),$(PRBTREE_PC_COMMENT),$(VENDOR_URL),,,,$(addprefix \
