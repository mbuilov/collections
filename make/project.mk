...
PRODUCT_NAMES_H = $(if $(filter prbtree/lib.mk,$(CURRENT_MAKEFILE)),prbtree_vers.h)

# version info for a dll
VENDOR_NAME      := Michael M. Builov
VENDOR_URL       := https://github.com/mbuilov/collections
PRODUCT_NAME     := $(if $(filter prbtree/lib.mk,$(CURRENT_MAKEFILE)),Red-black tree with parent pointers,Embedded Collections library)
